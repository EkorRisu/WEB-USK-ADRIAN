                ...
                @forelse ($kategoris as $index => $category)
                    <div class="category-card" data-category="{{ strtolower($category->nama) }}">
                        <div class="card-header">
                            ...
                            <div class="card-menu">
                                ...
                                <div class="menu-dropdown">
                                    <a href="{{ route('admin.kategori.edit', $category->id) }}" class="menu-item">
                                        <span class="menu-icon">✏️</span>
                                        Edit Category
                                    </a>
                                    <button class="menu-item delete-item" onclick="confirmDelete({{ $category->id }})">
                                        <span class="menu-icon">🗑️</span>
                                        Delete Category
                                    </button>
                                </div>
                        ...
                        <div class="card-image">
                            @if ($category->foto)
                                <img src="{{ asset('storage/' . $category->foto) }}" alt="{{ $category->nama }}" class="category-image">
                                <div class="image-overlay">
                                    <button class="view-image-btn" onclick="viewImage('{{ asset('storage/' . $category->foto) }}', '{{ $category->nama }}')">
                                        👁️ View Full
                                    </button>
                                </div>
                            @else
                        ...
                        <div class="card-actions">
                            ...
                            <form id="delete-form-{{ $category->id }}" action="{{ route('admin.kategori.destroy', $category->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="action-btn-small btn-delete" onclick="confirmDelete({{ $category->id }})">
                                    <span class="btn-icon">🗑️</span>
                                    Delete
                                </button>
                            </form>
