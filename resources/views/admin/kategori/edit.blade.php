...
<div class="form-container">
    ...
    <div class="form-wrapper">
        <div class="form-card">
            ...
            <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST" id="categoryForm">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper {{ old('nama', $kategori->nama) ? 'focused' : '' }}">
                ...
                <div class="form-group">
                    ...
                    <div class="textarea-wrapper {{ old('deskripsi', $kategori->deskripsi) ? 'focused' : '' }}">
                        ...
                        <div class="textarea-counter">
                            <span id="charCount">{{ strlen(old('deskripsi', $kategori->deskripsi)) }}</span>/500
                            characters
                        </div>
                    </div>
                    @error('deskripsi')
        ...
        <div class="help-card">
            <h4>💡 Tips for Editing Categories</h4>
            <ul>
                <li><strong>Keep Consistency:</strong> Maintain naming conventions</li>
                <li><strong>Update Descriptions:</strong> Ensure they reflect current scope</li>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateProgress() {
                    ...
                    const progress = (filledFields / 2) * 100;
                    progressFill.style.width = progress + '%';

                    // Change progress bar color based on completeness
                    if (progress === 100) {
                ...
                // Initial progress check on page load
                updateProgress();
            });
</script>
@endpush
