    ...
    <div class="form-container">
            ...
            <div class="form-wrapper">
                <div class="form-card">
                    ...
                    <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST" enctype="multipart/form-data" id="categoryForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="textarea-wrapper focused">
                                ...
                                <div class="textarea-counter">
                                    <span id="charCount">{{ strlen(old('deskripsi', $kategori->deskripsi)) }}</span>/500 characters
                                </div>
                            </div>
                            @error('deskripsi')
                                <div class="error-message">
                        ...
                        @if($kategori->foto)
                            <div class="form-group">
                                ...
                                <div class="current-image-wrapper">
                                    <img src="{{ asset('storage/' . $kategori->foto) }}" alt="Current Category Image" class="current-image">
                ...
                <div class="help-card">
                    ...
                    <ul>
                        ...
                        <li><strong>Image Quality:</strong> Use high-resolution images</li>
